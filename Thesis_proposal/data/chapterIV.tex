...
\end{split}
\end{equation}
Because the Poisson process are independent, the distribution of $\underline{\mathbf{U}}$ can be written as
...
\end{split}
\end{equation}
The conditional distribution of the $\underline{\mathbf{P}}$ given $\underline{\mathbf{U}}=\underline{\mathbf{u}}$, is
...
f_{\mathbf{P}_j | \mathbf{U}_j} (\mathbf{p}_{j}|\mathbf{u}_j) .
\end{equation}
With the conditional distribution of the $\underline{\mathbf{P}}$ given $\underline{\mathbf{U}}=\underline{\mathbf{u}}$ and distribution of $\underline{\mathbf{U}}$, we can compute the marginal distribution of $\underline{\mathbf{P}}$.
...
(\mathbf{p}_j|\mathbf{u}_j) d\mathbf{u}_j .
\end{align}
Now we can the posterior distribution of $R_{\mathrm{t}}$ given $\underline{\mathbf{P}}$ by substituting \eqref{equation:distU},\eqref{equation:CondDistP},\eqref{equation:MarginalDistP} into \eqref{equation:PosdistRt}.
\newline
...
In this section, we assume the Poisson intensity parameters $\lambda_{\mathrm{t}}$ and $\lambda_{\mathrm{o}}$ are unknown. Under this assumption, the distribution of $\underline{\mathbf{U}}$ can be written as
\begin{equation}
...
\frac{\lambda_{\mathrm{t}}^{r_{\mathrm{t}}}
	\lambda_{\mathrm{o}}^{r_{\mathrm{o}}}}
{r_{\mathrm{t}}! r_{\mathrm{o}}!} \\
&\qquad \times \sum_{\{ \mathbb{I} \subset [n_{\mathrm{a}}]
	: |\mathbb{I}| = r_{\mathrm{t}} \}}
\prod_{j \in \mathbb{I}}
\mathcal{I}_{\mathcal{A}_{\mathrm{t}}}(j)
\prod_{j \in \mathbb{I}^{\mathrm{c}}}
...
\end{split}
\end{equation}
Now we can use numerical methods to get the values of $\lambda_{\mathrm{t}}$ and $\lambda_{\mathrm{o}}$ maximizing the likelihood function. After we obtain $\lambda_{\mathrm{t}}$ and $\lambda_{\mathrm{o}}$. The maximum likelihood estimator is calculated
\begin{equation} 
\begin{split}
\hat{R}_{\mathrm{t}}
